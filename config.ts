...
export const PROJECTS = [
  {
    ...
    description:
      "The aim of this work is to adapt the console spim simulator by compiling it to JavaScript using Emscripten technology, in order to embed the simulator in the web interface.",
